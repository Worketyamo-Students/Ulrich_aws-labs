...
const Icons: React.FC<iconsProps> = ({ nom1, nom2 }) => {
    return (
        <div className="flex flex-col gap-3 lg:gap-[4vh] mt-3 lg:mt-[4vh]">
            ...
            <div className="flex flex-col gap-2"> {/*icons*/}
                <div className="flex items-center justify-center shadow-sm gap-1 w-full h-[5vh] rounded-[6px] text-[10px] lg:text-[1.1vw] text-title2 border-[1px] border-bord">
