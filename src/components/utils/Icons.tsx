    ...
    return (
        <div className="flex flex-col gap-[4vh] mt-[4vh]">
            <div className="flex gap-2 items-center justify-between"> {/* divider */}
                ...
                <h3 className="text-gris text-[1vw] font-medium">OU AVEC</h3>
                <div className="w-[30%] h-[1px] bg-bord"></div>
            </div>
            <div className="flex flex-col gap-3"> {/*icons*/}
                <div className="flex items-center justify-center shadow-sm gap-1 w-full h-[5vh] rounded-[6px] text-[1.1vw] text-title2 border-[1px] border-bord">
